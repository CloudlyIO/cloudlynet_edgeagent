...
- The local `testsuite` is a separate mock microservice for functional testing, not production code.
...
- `testsuite`: mock CloudlyNet and GenieACS service for Docker functional tests.
